                    ...
                    <div className="centerOfOperation__list" >
                        <div className="centerOfOperation__list-item ">
                            <div className="centerOfOperation__image">
                                <img onMouseEnter={currentItem} name={'thinking'} src={"https://image.flaticon.com/icons/png/512/1491/1491416.png"} style={{ background: "#FACC2E" }} />
                                <h6>{'Thinking'}</h6>
                            </div>
                        </div>
                        <div className="centerOfOperation__list-item">
                            <div className="centerOfOperation__image">
                                <img onMouseEnter={currentItem} name={'feeling'} src={"https://image.flaticon.com/icons/svg/1301/1301414.svg"} style={{ background: "#F25C5C" }} />
                                <h6>{'Feeling'}</h6>
                            </div>
                        </div>
                        <div className="centerOfOperation__list-item">
                            <div className="centerOfOperation__image">
                                <img onMouseEnter={currentItem} name={'intuition'} src={"https://image.flaticon.com/icons/png/512/1491/1491376.png"} style={{ background: "#0080FF" }} />
                                <h6>{'Intuition'}
                                </h6>
                            </div>
                        </div>
