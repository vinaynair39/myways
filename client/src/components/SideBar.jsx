            ...
            <div className="dashboard__sidebar">
                ...
                <div className="dashboard__sidebar-grid1">
                    ...
                    >
                        ...
                        Discover Yourself
              <FontAwesomeIcon icon={faCaretDown} className="dashboard__icon mr-0 ml-2" />
                    </div>
                    <div className="collapse list-unstyled" id="pageSubmenu">
                        <div className="dashboard__sidebar1-item dashboard__sub-item"
                            ...
                            <FontAwesomeIcon icon={faStar} className="dashboard__sub-icon" /> <Link to="CognitiveIntelligence">Cognitive
                            Intelligence</Link>
                        </div>
                        <div className="dashboard__sidebar1-item dashboard__sub-item">
                            <FontAwesomeIcon icon={faStar} className="dashboard__sub-icon" /> <Link to="careerValues">Career Values
                            </Link>
                        </div>
                        <div className="dashboard__sidebar1-item dashboard__sub-item">
                        ...
                        <div className="dashboard__sidebar1-item dashboard__sub-item mb-3">
                            <FontAwesomeIcon icon={faStar} className="dashboard__sub-icon" /> Subject Interest
              </div>
                    </div>
                    ...
                    <div
                        className="dashboard__sidebar1-item"
                    >
                        <FontAwesomeIcon icon={faExclamationCircle} className="dashboard__icon" />
                        Career Library
            </div>
                    <div
                        className="dashboard__sidebar1-item"
                    ...
                    <div>
                        {isAuthenticated && (
                            <div className="dashboard__sidebar2-item">
                                <FontAwesomeIcon icon={faSignOutAlt} className="dashboard__icon" />
                                <a
                                    href=""
                                    onClick={logout}
                                    className="dashboard__text-white"
                                >
                                    Logout
              </a>
                            </div>
