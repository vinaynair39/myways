...
export const getCurrentTest = (testName = "deductiveReasoning") => {
    return (dispatch, getState) => {
        ...
        return axios.get(`http://13.234.156.115:3000/api/test/${testName}`).then(res => {
...
export const getCurrentAnswers = (testName = "deductiveReasoning") => {
    return (dispatch, getState) => {
        ...
        return axios.get(`http://13.234.156.115:3000/api/answers/${testName}`).then(res => {
...
export const sendAnswers = (answers) => {
    return (dispatch, getState) => {
        ...
        dispatch({ type: LOADING_UI });
        console.log(answers)
        return axios.post(`http://13.234.156.115:3000/api/result/answers`, answers).then(res => {
